package com.droid.flippy.qr.server
...
import com.droid.flippy.MainActivity
...
class QrSpooferService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP = "com.droid.flippy.qr.STOP_SERVICE"
    }
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, "qr_spoofer_channel")
            .setContentTitle("Flippy Spoofer")
            .setContentText(getString(R.string.qr_server_active_bg))
