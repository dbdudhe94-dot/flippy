...
class BleSpamWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE_IOS = "com.droid.flippy.action.TOGGLE_IOS"
        const val ACTION_TOGGLE_SAMSUNG = "com.droid.flippy.action.TOGGLE_SAMSUNG"
        const val ACTION_TOGGLE_ANDROID = "com.droid.flippy.action.TOGGLE_ANDROID"
        const val ACTION_TOGGLE_WINDOWS = "com.droid.flippy.action.TOGGLE_WINDOWS"
        const val ACTION_STOP_ALL = "com.droid.flippy.action.BLE_STOP_ALL"
