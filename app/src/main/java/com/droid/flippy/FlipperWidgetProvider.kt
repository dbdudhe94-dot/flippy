...
class FlipperWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val ACTION_UP = "com.droid.flippy.action.FLIPPER_WIDGET_UP"
        const val ACTION_DOWN = "com.droid.flippy.action.FLIPPER_WIDGET_DOWN"
        const val ACTION_LEFT = "com.droid.flippy.action.FLIPPER_WIDGET_LEFT"
        const val ACTION_RIGHT = "com.droid.flippy.action.FLIPPER_WIDGET_RIGHT"
        const val ACTION_OK = "com.droid.flippy.action.FLIPPER_WIDGET_OK"
        const val ACTION_BACK = "com.droid.flippy.action.FLIPPER_WIDGET_BACK"

        const val ACTION_BLE_IOS = "com.droid.flippy.action.FLIPPER_WIDGET_BLE_IOS"
        const val ACTION_BLE_SAMSUNG = "com.droid.flippy.action.FLIPPER_WIDGET_BLE_SAMSUNG"
        const val ACTION_BLE_ANDROID = "com.droid.flippy.action.FLIPPER_WIDGET_BLE_ANDROID"
        const val ACTION_BLE_WINDOWS = "com.droid.flippy.action.FLIPPER_WIDGET_BLE_WINDOWS"
