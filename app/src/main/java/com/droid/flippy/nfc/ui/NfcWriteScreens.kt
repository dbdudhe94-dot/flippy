...
import com.droid.flippy.nfc.NfcNdefPayloads
import com.droid.flippy.nfc.NfcViewModel
import com.droid.flippy.nfc.NfcWriteOutcome
import com.droid.flippy.nfc.ui.enableNfcForegroundDispatch
...
fun NfcWriteContactScreen(navController: NavController, viewModel: NfcViewModel) {
    ...
    if (showPhoneDialog) {
        AlertDialog(
            ...
            dismissButton = {
                com.droid.flippy.AccentButton(onClick = { showPhoneDialog = false }) { Text(stringResource(R.string.cancel)) }
            },
        )
    }
}
