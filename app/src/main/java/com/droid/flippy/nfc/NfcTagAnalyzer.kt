...
object NfcTagAnalyzer {
    suspend fun analyzeIntent(
        intent: Intent,
        emptyNdefContent: String = "Empty NDEF message",
        decodeErrorPrefix: String = "Decoding error",
    ): NfcScanEntity? = withContext(Dispatchers.IO) {
        ...
        if(ndef != null) {
            try {
                ...
                if(msg != null) {
                    val summary = summarizeNdef(msg, emptyNdefContent, decodeErrorPrefix)
        ...
        val verdict = buildString {
            ...
            if(passwordSupported == true) {
                when(passwordEnabled) {
                    true -> append(" � Password: ��������")
                    false -> append(" � Password: ���������")
                    null -> append(" � Password: ����������")
                }
            }
    ...
    private fun detectEmv(tag: Tag): String? {
        ...
        return try {
            ...
            if(sw1 == 0x90 && sw2 == 0x00) {
                ...
                return buildString {
                    appendLine("���: EMV Contactless")
                    appendLine("��������: ISO 14443-4")
                    appendLine("��������� APDU: ��")
                    appendLine("��������� �������: ${paymentSystem ?: "�� ����������"}")
                    appendLine("���������� �� �����: ${aids.size}")
                    appendLine("AID: ${if(aids.isNotEmpty()) aids.joinToString(", ") else "�"}")
                    append("PPSE: 2PAY.SYS.DDF01")
                    if(appLabels.isNotEmpty()) {
                        appendLine()
                        append("����� ����������: ${appLabels.joinToString(", ")}")
                    }
                }
            }
            null
    ...
    private fun detectPaymentSystem(aids: List<String>, appLabels: List<String>): String? {
        ...
        if(aidUpper.any { it.startsWith("A000000658") }) return "���"
