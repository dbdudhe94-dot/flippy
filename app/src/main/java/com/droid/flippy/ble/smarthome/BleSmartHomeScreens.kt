package com.droid.flippy.ble.smarthome
...
import com.droid.flippy.M3SegmentedList
        ...
        MaterialBackground(accentColor = accent) {
            Column(
                ...
                SectionTopBar(
                    ...
                    actions = {
                        FlippyIconButton(onClick = {
                            ...
                            if (isScanning) FlippyCircularProgressIndicator(Modifier.size(18.dp), strokeWidth = 2.dp)
                ...
                if (!hasPerm) {
                    ...
                    Spacer(Modifier.height(12.dp))
                    com.droid.flippy.AccentButton(onClick = { ensurePerms() }) { Text(stringResource(R.string.ble_allow)) }
                    return@Column
                }
                if (bluetoothAdapter.isEnabled != true) {
                    Text(stringResource(R.string.ble_off_enable), color = MaterialTheme.colorScheme.onBackground)
                    return@Column
                }
                ...
                if (items.isEmpty()) {
                    ...
                    if (isScanning) {
                        Box(Modifier.fillMaxWidth().padding(16.dp), contentAlignment = Alignment.Center) {
                            FlippyCircularProgressIndicator(Modifier.size(24.dp), strokeWidth = 2.5.dp)
                        }
                    }
                }
            }
                ...
                Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    if (connecting) {
                        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                            FlippyCircularProgressIndicator(Modifier.size(20.dp), strokeWidth = 2.dp)
