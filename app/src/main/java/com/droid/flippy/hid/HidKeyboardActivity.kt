...
import com.droid.flippy.AppLocale
import com.droid.flippy.FlippyCircularProgressIndicator
import com.droid.flippy.FlippyTheme
import com.droid.flippy.LocalExpressiveEnabled
import com.droid.flippy.LocalLiquidGlassBackdrop
import com.droid.flippy.LocalLiquidGlassButtons
import com.droid.flippy.LocalLiquidGlassEnabled
import com.droid.flippy.LocalLiquidGlassNav
import com.droid.flippy.LocalLiquidGlassTopBars
                ...
                Surface(modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
                    ...
                    Scaffold(
                        topBar = {
                            SectionTopBar(
                                ...
                                transparent = true,
                                actions = {
                                    FlippyIconButton(onClick = { startDiscovery(adapter) }) {
                                        if (scanning) FlippyCircularProgressIndicator(modifier = Modifier.size(20.dp), strokeWidth = 2.dp)
                        ...
                        Column(
                            ...
                            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                                ...
                                if (scanning) { Row(verticalAlignment = Alignment.CenterVertically) { FlippyCircularProgressIndicator(Modifier.size(14.dp), strokeWidth = 2.dp); Spacer(Modifier.width(6.dp)); Text(stringResource(R.string.hid_scanning), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant) } }
                            }
                    ...
                    if (showBlueDuckyInfoDialog.value) {
                        AlertDialog(
                            ...
                            confirmButton = {
                                com.droid.flippy.AccentButton(onClick = { showBlueDuckyInfoDialog.value = false }) {
                    ...
                    if (showLongConnectingDialog.value) {
                        AlertDialog(
                            ...
                            confirmButton = {
                                com.droid.flippy.AccentButton(onClick = { showLongConnectingDialog.value = false }) {
                                    Text(stringResource(R.string.got_it))
                                }
                            }
                        )
