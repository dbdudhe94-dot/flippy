...
private fun DocumentCard(document: PrintDocument?, onPick: () -> Unit) {
    AppCard {
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            com.droid.flippy.AccentButton(onClick = onPick, modifier = Modifier.fillMaxWidth()) {
...
private fun ManualPrinterDialog(
    ...
    AlertDialog(
        ...
        dismissButton = { com.droid.flippy.AccentButton(onClick = onDismiss) { Text(stringResource(R.string.wifi_print_cancel)) } },
    )
}
