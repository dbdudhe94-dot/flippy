    ...
    MaterialBackground(accentColor = MaterialTheme.colorScheme.primary) {
        Column(Modifier.fillMaxSize()) {
            SectionTopBar(
                ...
                actions = {
                    FlippyIconButton(onClick = { navController.navigate("plugin_security") }) {
...
private fun SafeModeCard() {
    MaterialCard(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(14.dp)) {
            ...
            FlippySwitch(checked = true, onCheckedChange = { enabled -> if (!enabled) PluginManager.disableSafeMode() })
        }
    }
}
...
private fun PluginCard(plugin: LoadedPlugin, safeMode: Boolean) {
    ...
    MaterialCard(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            Box {
                FlippyIconButton(onClick = { menuExpanded = true }) {
